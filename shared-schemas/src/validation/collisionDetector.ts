...
export function checkObjectOverlap(a: PlacedObject, b: PlacedObject): RuleViolation | null {
...
export function checkObjectInRoom(obj: PlacedObject, roomPolygon: Point2D[]): RuleViolation | null {
...
export function checkObjectVsOpening(obj: PlacedObject, openings: Opening[]): RuleViolation | null {
...
export function checkMinClearance(
  obj: PlacedObject,
  others: PlacedObject[],
  minMm: number
): RuleViolation | null {
...
function wallAngleDeviationFromOrthogonal(wall: WallSegment2D): number {
...
export function detectCostHints(
  obj: PlacedObject,
  wall: WallSegment2D,
  openings: Opening[]
): RuleViolation[] {
  const hints: RuleViolation[] = [];

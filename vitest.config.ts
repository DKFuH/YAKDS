...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@yakds/shared-schemas': fileURLToPath(new URL('./shared-schemas/src', import.meta.url)),
      '@yakds/dxf-export': fileURLToPath(new URL('./interop-cad/dxf-export/src', import.meta.url)),
      '@yakds/dxf-import': fileURLToPath(new URL('./interop-cad/dxf-import/src', import.meta.url)),
      '@yakds/skp-import': fileURLToPath(new URL('./interop-sketchup/skp-import/src', import.meta.url)),
